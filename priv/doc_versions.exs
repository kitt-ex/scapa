%{
  {Scapa.CLI, :check_versions, 1} => "MTE5ODExODg",
  {Scapa.CLI, :generate_versions, 1} => "MzQwMTI5OTU",
  {Scapa.Code, :defined_modules, 2} => "OTQyMjEzMjI",
  {Scapa.Code, :functions_with_doc, 1} => "NzQ1NTk1Nzg",
  {Scapa.Code, :stringify, 1} => "MTAyNzU5NjQ1",
  {Scapa.Config, :default_config, 0} => "Mzg3NDgyMg",
  {Scapa.Config, :default_config_path, 0} => "NTEwNjkzNTk",
  {Scapa.Config, :fetch_config, 1} => "NzE2NTY5NDc",
  ...
  {Scapa.SourceFile, :writeable_contents, 1} => "OTM4MzI4Ng",
